        ...
        return (
          <div className="relative flex justify-center" key={index}>
            <motion.div
              ...
              className="cursor-pointer relative flex justify-center z-30 md:w-[144px] w-[70px] md:h-[140px] h-[71px] rounded-md bg-[#092a25] md:p-5 p-3 shadow-[0px_1px_5px_0px_#000]"
            >
              <img
                src={data}
                alt="logo skills mattmwln"
                className={`${
                  index === 0 || index === 6
                    ? "md:w-[90px] w-[80px]"
                    : "md:w-16 w-6"
