  ...
  return (
    ...
    >
      <div className="relative md:w-[590px] w-[315px]">
        ...
        />
       <div>
    <h2 className="md:text-[56px] text-[30px] md:text-left font-bold text-primary text-transparent bg-clip-text bg-gradient-to-r from-[#27a589] to-[#092a25]">
        ...
        <img
          ...
          decoding="async"
          loading="lazy"
          alt="projects shape mattmwln"
          className="absolute -z-10 top-0 -right-1 md:w-12 w-6"
        />
      </div>
      <p className="xl:text-2xl md:text-base text-sm xl:leading-9 text-medium text-center max-w-[50rem]" style={{ color: "#d2f5ea" }}>
