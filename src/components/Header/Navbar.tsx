...
//           className="cursor-pointer bg-[#1a554a] hover:bg-{#1a554a} rounded-md outline outline-sky-200 lg:p-2.5 p-2 drop-shadow-sm"
//         >
...
//         } lg:hidden fixed top-0 bg-[#0e0e11] w-full h-screen transition-all duration-300 ease-out z-50`}
//       >
//         <div className="mx-5 font-extrabold text-2xl italic fixed top-7" style={{ color: "#1a554a" }}>
//           MATTMWLN.
//         </div>
